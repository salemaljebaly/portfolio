...
import { ChevronLeft, ChevronRight, ExternalLink, Filter, Github } from "lucide-react";
                    ...
                    <div className={`flex flex-wrap gap-2 mb-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
                      ...
                      {project.tech.length > 4 && (
                        <span className="px-2 py-1 text-xs text-muted-foreground">
                          +{project.tech.length - 4} {String(t('projects.more'))}
                        </span>
                      )}
                    </div>
                    ...
                    <div className={`flex items-center gap-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
                      {project.links.github && (
                        <a
                          ...
                          className={`flex items-center gap-1 text-sm text-muted-foreground hover:text-primary transition-colors ${isRTL ? 'flex-row-reverse' : ''}`}
                        >
                      ...
                      <button
                        ...
                        className={`${isRTL ? 'mr-auto' : 'ml-auto'} flex items-center gap-1 text-sm text-primary hover:underline ${isRTL ? 'flex-row-reverse' : ''}`}
                      >
                        {isRTL ? (
                          <ChevronLeft
        ...
        <section className="py-20 bg-muted/50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`inline-flex items-center gap-2 px-8 py-4 text-lg font-medium rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors ${isRTL ? 'flex-row-reverse' : ''}`}
            >
